...
dGroup.append("text")
    ...
    .attr("transform", "translate(" + (outerRadius - 85) + ","  + (outerRadius * 1.15) +")")
    //.text("* Cumulative trade imbalance since 2003")
    .text("2003年以来贸易顺差及各省进出口情况")
    .style("font-size","0px");
...
gradientGroup.append("rect")
    ...
    .attr("width",0)
    .style("fill","url(#gradient1)");//这里渐变色的出处？？
